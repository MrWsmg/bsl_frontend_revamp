...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  supervisor_pending: { label: 'Pending Manager Review',   className: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
  manager_approved:   { label: 'Pending Finance Approval', className: 'bg-blue-100 text-blue-800 border-blue-200'       },
