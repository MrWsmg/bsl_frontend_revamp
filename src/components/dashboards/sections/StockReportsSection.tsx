      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            ...
            <Select value={String(selectedFarm ?? '')} onValueChange={(val) => setSelectedFarm(val)}>
              <SelectTrigger className="w-full border border-gray-300 rounded-md px-3 py-2"><SelectValue placeholder="All Farms" /></SelectTrigger>
              <SelectContent>
