...
import { BarChart3, ClipboardList, TrendingUp, FileText, PackageCheck, Warehouse, CalendarDays, ReceiptText } from 'lucide-react';
...
export const FinancialControllerDashboard: React.FC<FinancialControllerDashboardProps> = ({ user, onLogout }) => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'weekly_sheet':
        return <SharedWeeklySheetSection />;
      case 'payment_summary':
        return <SharedPaymentSummarySection />;
      case 'payslip':
        return <SharedPayslipSection />;
      case 'proc-smr':
